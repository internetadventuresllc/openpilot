...
private:
  ...
  QSet<QString> advancedLateralTuneKeys = {"ForceAutoTune", "ForceAutoTuneOff", "ForceTorqueController", "HondaEPSClampReleased", "SteerDelay", "SteerFriction", "SteerLatAccel", "SteerKP", "SteerRatio"};
